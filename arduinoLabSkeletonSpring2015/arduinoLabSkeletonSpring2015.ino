...
int alarmThreshold = 200; //declare a variable that is the threshold for the alarm to trigger. THis corresponds to a digitized
...
void loop() {
  // put your main code here, to run repeatedly:
                               ...
                               //if not greater than, do something else
                                   //turn off LED
